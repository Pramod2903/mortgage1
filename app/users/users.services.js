...
// angular.module('petList').factory('petListService', ['$http', '$window', '$rootScope','config',
//   function ($http, $window, $rootScope,config) {

//     var service = {};
//     var myPetList = undefined;
//     var petList = undefined;

//     var totalPages, startPage, endPage;
//     var startIndex, endIndex, pages;
//     var totalItems;
//     var currentPage = 1;
//     var pageSize = 10; var searchHit = false;
...
//     service.getSearchHit = function(){
//       return searchHit;
//     }

//     service.isSearchHit = function(){
//       searchHit = true;
//     }
...
//         data: petObj,
//         params: params,
//         url: config.url+'/api/pets/filter'
//       });
...
//         method: 'PUT',
//         type: 'JSON',
//         url: config.url+'/api/pets/' + petObj.petId
//       });
//     }
